...
| Activity | Time |
|----------------------------------------------------|--------------------|
| 1. [Getting the Open Human Mobility Data in a Reproducible Way using `spanishoddata` and aggregating the data using `duckdb`](1-mobility-data-slides-container.qmd) | 55 |
| 2. [Visualization of Mobility Flows Using `flowmapper` and `flowmapblue`](2-flow-vis-slides-container.qmd) | 40 |
| Break | 10 |
| 3. [Accessibility and its Relation to Actual Mobility](3-accessibility-vs-mobility-slides-container.qmd) | 75 |
